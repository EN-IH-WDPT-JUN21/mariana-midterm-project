...
public interface IAdminController {
    ...
    Account store(AccountCreationRequestDTO accountCreationRequestDTO) throws UserHasMultipleAccountsException;
    User store(UserCreationRequestDTO userCreationRequestDTO) throws UserAlreadyExistsException;
}
